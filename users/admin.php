...
<h1 class="text-center">Versión del panel de administración <?=$user_spice_ver?></h1>
...
<div class="row"> <!-- row for Users, Permissions, Pages, Email settings panels -->
	...
	<span class="pull-left"><a href="admin_users.php">Administrar</a></span>
...
<div class="row "> <!-- rows for Info Panels -->
	<h2>Información de paneles</h2>
	<div class="col-xs-12 col-md-6">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Todos los usuarios</strong> <span class="small">(que iniciaron sesión)</span></div>
	<div class="panel-body text-center">
	<div class="row">
		<div class="col-xs-3 "><h3><?=$hourCount?></h3><p>por hora</p></div>
		<div class="col-xs-3"><h3><?=$dayCount?></h3><p>por día</p></div>
		<div class="col-xs-3 "><h3><?=$weekCount?></h3><p>por semana</p></div>
		<div class="col-xs-3 "><h3><?=$monthCount?></h3><p>por mes</p></div>
	</div>
	</div>
	</div><!--/panel-->
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Todos los visitantes</strong> <span class="small">(que iniciaron sesión o no)</span></div>
	<div class="panel-body">
	<?php  if($settings->track_guest == 1){ ?>
	<?="En los últimos 30 minutos, la cuenta de visitantes fue ".count_users()."<br>";?>
	<?php }else{ ?>
	Seguimiento de usuarios apagado. Presione "Seguimiento de usuarios" para mostrar estadísticas avanzadas.
	<?php } ?>
	</div>
	</div><!--/panel-->
	...
	<div class="col-xs-12 col-md-6">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Usuarios que iniciaron sesión</strong> <span class="small">(en las últimas 24 horas)</span></div>
	<div class="panel-body">
	<div class="uvistable table-responsive">
	<table class="table">
	<?php if($settings->track_guest == 1){ ?>
	<thead><tr><th>Nombre de usuario</th><th>IP</th><th>última actividad</th></tr></thead>
	<tbody>
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Eventos de seguridad</strong><span align="right" class="small"><a href="tomfoolery.php"> (Ver Logs)</a></span></div>
	<div class="panel-body" align="center">
	Hubieron<br>
	<h2><?=$tomC?></h2>
	eventos de seguridad disparados
	</div>
	</div><!--/panel-->
	...
	<div class="col-xs-12 col-md-6"> <!-- Site Settings Column -->
		...
		<div class="form-group">
			...
			<select id="recaptcha" class="form-control" name="recaptcha">
				<option value="1" <?php if($settings->recaptcha==1) echo 'selected="selected"'; ?> >Activado</option>
				<option value="0" <?php if($settings->recaptcha==0) echo 'selected="selected"'; ?> >Desactivado</option>
				<option value="2" <?php if($settings->recaptcha==2) echo 'selected="selected"'; ?> >Para ingreso únicamente</option>
			</select>
		</div>

		<!-- Messaging Option -->
		<div class="form-group">
			<label for="messaging">Mensajería (Experimental)</label>
			<select id="messaging" class="form-control" name="messaging">
				<option value="1" <?php if($settings->messaging==1) echo 'selected="selected"'; ?> >Activado</option>
				<option value="0" <?php if($settings->messaging==0) echo 'selected="selected"'; ?> >Desactivado</option>
			</select>
		</div>
